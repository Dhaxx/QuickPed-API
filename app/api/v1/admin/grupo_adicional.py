...
def create_grupo_adicional(data: GrupoAdicionalCreate, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("grupos_adicionais", "editar"))):
...
def get_grupos_adicionais(session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), produto_id = int, _=Depends(require_permission("grupos_adicionais", "visualizar"))):
...
def update_grupo_adicional(grupo_id: int, data: GrupoAdicionalUpdate, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("grupos_adicionais", "editar"))):
...
def delete_grupo_adicional(grupo_id: int, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("grupos_adicionais", "editar"))):
