...
def create_produto(data: ProdutoCreate, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("produtos", "editar"))):
...
def get_produtos( session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("produtos", "visualizar"))):
...
def update_produto( produto_id: int, data: ProdutoUpdate, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("produtos", "editar"))):
...
def delete_produto( produto_id: int, session = Depends(get_session), estabelecimento_id: int = Depends(get_current_estabelecimento), _=Depends(require_permission("produtos", "editar"))):
